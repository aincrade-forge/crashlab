...
namespace CrashLab.UI
{
    public class CrashUIBuilder : MonoBehaviour
    {
        ...
        private static readonly ButtonEntry[] ButtonDefinitions =
        {
            ...
            new ButtonEntry { label = "Android: Kotlin OOM", action = ActionType.AndroidOomKotlin },
            new ButtonEntry { label = "Android: Kotlin OOM (background)", action = ActionType.AndroidOomKotlinBackground },
        ...
        private Action Resolve(ActionType type)
        {
            switch (type)
            {
                ...
                case ActionType.AndroidOomKotlin: return CrashActions.AndroidOomKotlin;
                case ActionType.AndroidOomKotlinBackground: return CrashActions.AndroidOomKotlinBackground;
        ...
        private static Group MapGroup(ActionType type)
        {
            switch (type)
            {
                ...
                case ActionType.AndroidThrowKotlinBackground:
                case ActionType.AndroidOomKotlinBackground:
